## My changes to the forked AI Reinforcement Learning project


![Reinforcement Learning project](https://github.com/seio86/Minesweeper-AI-Reinforcement-Learning/blob/master/README_contributions.png)
